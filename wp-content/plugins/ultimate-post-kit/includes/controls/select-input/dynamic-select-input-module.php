...
defined('ABSPATH') || die();
class UltimatePostKit_Dynamic_Select_Input_Module {
	...
	public function init() {
		add_action('wp_ajax_upk_dynamic_select_input_data', array($this, 'getSelectInputData'));
	}
...
function ultimatePostKit_dynamic_select_input_module() {

	return UltimatePostKit_Dynamic_Select_Input_Module::get_instance();
}
ultimatePostKit_dynamic_select_input_module()->init();
