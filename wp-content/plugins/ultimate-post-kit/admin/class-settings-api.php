...
if (!class_exists('UltimatePostKit_Settings_API')) :
    ...
    class UltimatePostKit_Settings_API {
        ...
        function show_navigation() {
            ...
            //     $html .= sprintf('<li><a href="#%1$s" class="bdt-tab-item" id="bdt-%1$s" data-tab-index="%2$s">%3$s</a></li>', 'ultimate_post_kit_license_settings', $count, 'License');
            // }
            ...
            foreach ($this->settings_sections as $form) {
                ...
                <div id="<?php echo esc_attr($form['id']); ?>_page" class="upk-option-page">
                    ...
                    <div bdt-filter="target: .upk-options" class="upk-options-parent" id="upk-options-parent-<?php echo esc_attr($i); ?>">
                        ...
                        <?php if ($form['id'] == 'ultimate_post_kit_active_modules' or $form['id'] == 'ultimate_post_kit_third_party_widget' or $form['id'] == 'ultimate_post_kit_elementor_extend') : ?>

                            <div class="bdt-widget-filter-wrapper bdt-grid">

                                <div class="bdt-width-expand@l upk-widget-filter-nav bdt-visible@m">
                        ...
                        <form class="settings-save" method="post" action="admin-ajax.php?action=ultimate_post_kit_settings_save">
                            ...
                            <div class="ultimate-post-kit-footer-info bdt-container-xlarge">
