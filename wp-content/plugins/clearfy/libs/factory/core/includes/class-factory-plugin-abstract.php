...
abstract class Wbcr_Factory469_Plugin extends Wbcr_Factory469_Base {
	...
	/**
	 * Instance class Wbcr_Factory469_Request, required manages http requests
	 *
	...
	public function __construct($plugin_path, $data)
	{
		...
		if( wp_doing_ajax() && isset($_REQUEST['action']) ) {
			...
			if( "wfactory-469-prepare-component" == $_REQUEST['action'] ) {
				add_action('wp_ajax_wfactory-469-prepare-component', [$this, 'ajax_handler_prepare_component']);
			}
