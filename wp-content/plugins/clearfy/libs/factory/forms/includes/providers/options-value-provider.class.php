<?php
	...
	if( !class_exists('Wbcr_FactoryForms466_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms466_OptionsValueProvider implements Wbcr_IFactoryForms466_ValueProvider {
